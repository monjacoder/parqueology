...
def convert_csv_to_parquet(csv_file, parquet_file):
    if os.path.exists(parquet_file):
        return f"{parquet_file} already exists. Choose a different parquet file name, or delete the existing file."
    else:
        ...
        return f"File converted to {parquet_file} successfully!"
